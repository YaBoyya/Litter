...
urlpatterns = [
    ...
    path('u/<str:usertag>/notifications', views.notification_list,
         name='notifications'),
    path('u/<str:usertag>/notification/<str:pk>/delete',
         views.notification_delete,
         name="notification-delete"),
    path('u/<str:usertag>/notification/delete-read',
         views.notification_delete_read,
         name="notification-delete-read"),
    path('u/<str:usertag>/notification/read-all',
         views.notification_read_all,
         name="notification-read-all"),
    path('u/<str:usertag>/notification/<str:pk>/redirect',
